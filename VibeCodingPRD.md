...
- On narrow screens, the navigation should collapse into abbreviated labels, such as one- or two-letter abbreviations, when the display width drops below 300 pixels.
...
- When the screen width drops below 300 pixels, the navigation bar should collapse to abbreviated labels, such as one- or two-letter short forms, while still maintaining page navigation.
